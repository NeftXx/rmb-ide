...
public class AEntFunction extends Expression {
    public final Expression expression;

    public AEntFunction(NodeInfo info, Expression expression) {
        super(info);
    ...
    protected Object calculateValue(Scope scope) {
        ...
        if (typeTemp.isAssignable(expression.type)) {
            try {
                ...
                reportError("Error la cadena no se puede convertir en numero entero.");
            }
        } else {
